  ...
  if (schedules.length === 0 || forceBootstrap) {
    ...
    const gamesData = [
      ...
      {date: new Date(), map: GameMap.ABYSS, tournament_id: 1, stats: { team1_id: 1, team2_id: 2, winner_id: 1, team1_score: 13, team2_score: 5 , players_stats_team1: [
        { player_id: 1, game_stats_player1_id: 1, kills: 10, deaths: 5, assists: 3 },
        { player_id: 2, game_stats_player1_id: 1, kills: 5, deaths: 10, assists: 3 },
        { player_id: 3, game_stats_player1_id: 1, kills: 3, deaths: 5, assists: 10 },
        { player_id: 4, game_stats_player1_id: 1, kills: 5, deaths: 3, assists: 10 },
        { player_id: 5, game_stats_player1_id: 1, kills: 3, deaths: 5, assists: 10 },
      ], players_stats_team2: [
        { player_id: 6, game_stats_player2_id: 1, kills: 10, deaths: 5, assists: 3 },
        { player_id: 7, game_stats_player2_id: 1, kills: 5, deaths: 10, assists: 3 },
        { player_id: 8, game_stats_player2_id: 1, kills: 3, deaths: 5, assists: 10 },
        { player_id: 9, game_stats_player2_id: 1, kills: 5, deaths: 3, assists: 10 },
        { player_id: 10, game_stats_player2_id: 1, kills: 3, deaths: 5, assists: 10 },
      ]}, logs: [
        { round_state: {round: 1, isTradeHappening: false, team1_alive_players: [], team2_alive_players: [], team_won: null, finished: false}, duel_buff: 0.5, trade_buff: 0.5, trade: false, team1_player_id: 1, team2_player_id: 6, player_killed_id: 6 , last_duel_of_round: false},
        { round_state: {round: 1, isTradeHappening: false, team1_alive_players: [], team2_alive_players: [], team_won: null, finished: false}, duel_buff: 0.1, trade_buff: 1.5, trade: true, team1_player_id: 3, team2_player_id: 7, player_killed_id: 3, last_duel_of_round: false },
        { round_state: {round: 1, isTradeHappening: false, team1_alive_players: [], team2_alive_players: [], team_won: null, finished: false}, duel_buff: 0.1, trade_buff: 1.5, trade: false, team1_player_id: 2, team2_player_id: 7, player_killed_id: 7, last_duel_of_round: true },
        { round_state: {round: 2, isTradeHappening: false, team1_alive_players: [], team2_alive_players: [], team_won: null, finished: false}, duel_buff: 0.5, trade_buff: 0.5, trade: true, team1_player_id: 2, team2_player_id: 7, player_killed_id: 7, last_duel_of_round: false },
        { round_state: {round: 2, isTradeHappening: false, team1_alive_players: [], team2_alive_players: [], team_won: null, finished: false}, duel_buff: 0.5, trade_buff: 0.5, trade: false, team1_player_id: 3, team2_player_id: 8, player_killed_id: 8, last_duel_of_round: false },
        { round_state: {round: 2, isTradeHappening: false, team1_alive_players: [], team2_alive_players: [], team_won: null, finished: false}, duel_buff: 1.5, trade_buff: 0.5, trade: true, team1_player_id: 4, team2_player_id: 9, player_killed_id: 9, last_duel_of_round: false },
        { round_state: {round: 2, isTradeHappening: false, team1_alive_players: [], team2_alive_players: [], team_won: null, finished: false}, duel_buff: 0.5, trade_buff: 0.5, trade: true, team1_player_id: 5, team2_player_id: 10, player_killed_id: 10, last_duel_of_round: false },
      ]},
    ]
